...
public class WordMinPaths {
    ...
    private static List<List<String>> findMinPaths(String start, String end, ArrayList<String> list) {
        /* 首先我需要生成每个列表中字符串的邻居图 */
        list.add(start);
        ...
        * */
        ...
        getShortestWay(start, end, distancesMap, nextMap, path, res, shortest, 0);
        return res;
    }
    ...
    * 生成每个字符串的 邻居表
    * */
    private static HashMap<String, ArrayList<String>> getNextMap(ArrayList<String> list) {
    ...
    * */
    private static ArrayList<String> getNext(String wanted, ArrayList<String> strings, Set<String> stringSet) {
